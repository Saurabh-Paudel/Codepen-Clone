...
export default function RightLayout() {
  ...
  const dropdownStyle =
    "absolute bg-white text-black rounded shadow-lg mt-2 w-full max-w-[220px] top-[15%] right-2 z-50";
  ...
  return (
    <div className="flex flex-col sm:flex-col md:flex-row gap-2 mt-[65px] px-2 py-2">
      {/* Output Section */}
      <div className="flex-1 bg-[#282c34] p-4 mb-6 shadow-md">
        <h2 className="text-lg font-semibold mb-2 text-white">Output</h2>
        <iframe
          className="w-full h-[300px] md:h-[655px] border border-gray-700 rounded-md bg-white"
          srcDoc={srcCode}
          title="output"
      ...
      <div className="flex flex-col gap-1 w-full md:w-[500px]">
        {/* HTML Editor */}
        <div className="relative h-[300px] md:h-[240px] bg-[#282c34] rounded-lg shadow-md">
